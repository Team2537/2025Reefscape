...
public class ModuleIOHybridFXS implements ModuleIO {
    ...
    public void setTurnPosition(Rotation2d rotation) {
        // Use MotionMagic for FXS steer for smoother movement
        turnTalon.setControl(motionMagicTurnRequest.withPosition(rotation.getRotations()));
    }
}
