    ...
    fun getReefButton(face: FieldConstants.Reef.ReefFace, side: FieldConstants.Reef.Side): Trigger {
        return when (face) {
            FieldConstants.Reef.ReefFace.S1 -> when (side) { // South
                FieldConstants.Reef.Side.LEFT -> leftButtonBoard.button(10)
                FieldConstants.Reef.Side.CENTER -> leftButtonBoard.button(11)
                FieldConstants.Reef.Side.RIGHT -> leftButtonBoard.button(12)
            }
            ...
            FieldConstants.Reef.ReefFace.S4 -> when (side) { // North
                FieldConstants.Reef.Side.LEFT -> leftButtonBoard.button(1)
                FieldConstants.Reef.Side.CENTER -> leftButtonBoard.button(2)
                FieldConstants.Reef.Side.RIGHT -> leftButtonBoard.button(3)
            }
            FieldConstants.Reef.ReefFace.S5 -> when (side) { // Northwest
                FieldConstants.Reef.Side.LEFT -> leftButtonBoard.button(4)
                FieldConstants.Reef.Side.CENTER -> leftButtonBoard.button(5)
                FieldConstants.Reef.Side.RIGHT -> leftButtonBoard.button(6)
            }
            FieldConstants.Reef.ReefFace.S6 -> when (side) { // Southwest
                FieldConstants.Reef.Side.LEFT -> leftButtonBoard.button(7)
                FieldConstants.Reef.Side.CENTER -> leftButtonBoard.button(8)
                FieldConstants.Reef.Side.RIGHT -> leftButtonBoard.button(9)
            }
        }
    }
